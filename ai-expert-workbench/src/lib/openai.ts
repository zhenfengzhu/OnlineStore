...
notes 必须正好 30 条，每条包含标题、封面文案、正文、标签、拍摄建议、目标人群和风险提示。
...
任务：拆解用户粘贴的竞品小红书笔记。
analysisMarkdown 必须包含标题结构、卖点表达、用户痛点、评论区机会、可借鉴方向、不可照抄风险。
...
notes 返回 3 条可引流到商品页的笔记标题和正文。`,
    comment_ops: `${base}
任务：设计评论区运营方案。
analysisMarkdown 必须包含：置顶评论、问链接回复、质疑回复、说贵回复、对比竞品回复、安全/材质回复、评论区二次种草话术、可转成笔记的新问题。
supportReplies 至少 12 条，每条是一个评论场景和回复。`,
    viral_reuse: `${base}
任务：把一篇表现好的内容复用放大。
